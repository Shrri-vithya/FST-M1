...
public class consumerTest {
    ...
    public RequestResponsePact createPact(PactDslWithProvider builder) throws ParseException {
        ...
        DslPart bodySentCreateUser = new PactDslJsonBody()
                .numberType("id", 1432289)
                .stringType("firstName", "Shrri")
                .stringType("lastName", "Vithya")
                .stringType("email", "Shrri@cons.com");
    ...
    public void runTest() {
        ...
        map.put("id", 1432289);
        map.put("firstName", "Shrri");
        map.put("lastName", "Vithya");
        map.put("email", "Shrri@cons.com");
